        ...
        if (inline.value.type === "COMMENT") {
            ...
            if (checkIsDotFunction.toUpperCase() === "PARAMS") {
                ...
                for(let val of array) {
                    ...
                    replacement += readAndInjectToTemplate(tokenTree.branches[i], input, newLocalParams).trimStart() + '\n'
                }
                ...
                if (conditionValue) {
                    ...
                    // TODO: MAKE HELPER FUNCTION TO REMOVE ONE TAB FROM EACH LINE IN STRING
                    replacement = readAndInjectToTemplate(tokenTree.branches[i], input, localParams).trimStart()
                }
