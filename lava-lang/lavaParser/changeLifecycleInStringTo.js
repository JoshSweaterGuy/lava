...
function changeLifecycleInStringTo (inlineString, lifecycle) {
    ...
    if (inlineString.includes(lifeSymbol)) {
        ...
        let startIndex = (inlineString.length - 1) - LAVA_CONSTANTS.inlineLava.endInlineLava.length
        inlineString = inlineString.substring(0, startIndex) + " " + lifeSymbol + " " + lifecycle + inlineString.substring(startIndex)
    }
